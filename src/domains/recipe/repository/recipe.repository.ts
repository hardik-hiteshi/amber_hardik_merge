...
export class RecipeRepository {
  ...
  public async fetchOneByNiceName(
    where: object,
    profileFilter: object,
  ): Promise<RecipeDocument> {
    const recipe = await this.recipeModel.findOne(where, profileFilter);
  ...
  public async updateByQuery(
    ...
    const recipe = await this.recipeModel.findOneAndUpdate(query, fields, {
      new: true,
    });
  ...
  public async deleteByQuery(query: object): Promise<RecipeDocument> {
    const recipe = await this.recipeModel.findOneAndDelete(query);
  ...
  public async findOneByQuery(query: object): Promise<RecipeDocument> {
    return await this.recipeModel.findOne(query);
  }
